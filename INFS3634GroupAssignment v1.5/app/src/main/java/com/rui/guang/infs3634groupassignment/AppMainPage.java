...
//FRAGMENT CODE FROM:
// https://github.com/ChrisRisner/AndroidFragmentNavigationDrawer/blob/master/app/src/main/java/com/chrisrisner/fragmentsample/MainActivity.java

public class AppMainPage extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener, AbstractionFragment.OnFragmentInteractionListener,
        PolymorphismFragment.OnFragmentInteractionListener, InheritanceFragment.OnFragmentInteractionListener,
        EncapsulationFragment.OnFragmentInteractionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //FLOATING BUTTON ALTERNATE TO THE DRAWER 'HOME' BUTTON - returns to AppMainPage
        FloatingActionButton returnToMainPageButton = (FloatingActionButton) findViewById(R.id.fab);
        returnToMainPageButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AppMainPage.this, AppMainPage.class);
